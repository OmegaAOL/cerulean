namespace Cerulean
{
    partial class Menu_CreateAccount
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Menu_CreateAccount));
            ...
            this.label5.Text = "Optionally, you can also import a previous ATProto DID \r\n(Decentralized IDentifie" +
                "r) to a new account:";
            // 
            // label6
            // 
            ...
            this.viewTOSButton.TabStop = true;
            this.viewTOSButton.Text = "Bluesky Terms";
            this.viewTOSButton.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.viewTOSButton_LinkClicked);
            // 
            // Menu_CreateAccount
            // 
